...
% Set custom fonts like so. The fonts have to be installed on your system and fontspec might need a little help (see JetBrainsMono down below) if the fonts are named very specific.
