...
\begin{document}
    \input{misc/cover/_cover.tex} % Cover of the Work (IMPORTANT: SET YOUR PERSONAL INFORMATION IN THERE)
    ...
    \cleardoublepage
    \input{misc/oath/_oath.tex} % oath which has to be hand signed
    \newpage
    \cleardoublepage
    \appendix
    \chapter{Anhang}
    \label{apx}
    \cleardoublepage
    \input{misc/appendix/_appendix.tex}
\end{document}